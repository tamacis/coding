...
<!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">SM : Admin</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="tables.html">
            ...
            <span class="nav-link-text">Notfications</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
             href="#collapseCourse" data-parent="#exampleAccordion">
          ...
          <ul class="sidenav-second-level collapse" id="collapseCourse">
            ...
            <li>
              ...
              <a href="${cp}/Admin/Course/Display">
                  <i class="fa fa-fw fa-television"></i> Display Course</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Students">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
             href="#collapseStudent" data-parent="#exampleAccordion">
          ...
          <ul class="sidenav-second-level collapse" id="collapseStudent">
            ...
            <li>
              ...
              <a href="${cp}/Admin/Student/Display">
                  <i class="fa fa-fw fa-television"></i> Display Student</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Exams">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
             href="#collapseExams" data-parent="#exampleAccordion">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExams">
            <li>
              ...
              <a href="${cp}/Admin/Course/Add}">
                  <i class="fa fa-fw fa-plus" ></i> Add Exams</a>
            </li>
            <li>
                
              <a href="${cp}/Admin/Course/Display}">
                  <i class="fa fa-fw fa-television"></i> Display Exams</a>
            </li>
          </ul>
        </li>
