            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <div class="card card-register mx-auto mt-5">
                        <div class="card-header">Edit an course</div>
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/course/update?${_csrf.parameterName}=${_csrf.token}" 
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                        <label>Id: </label>
                                        <input type="text" name="id" value="${coursedata.id}" readonly />
                                        </div>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" name="title" id="title" type="text"
                                                   aria-describedby="nameHelp" value="${coursedata.title}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" name="price" id="price" type="text"
                                                   aria-describedby="nameHelp" value="${coursedata.price}" >
                                        </div>
                                        <div class="col-md-6">
