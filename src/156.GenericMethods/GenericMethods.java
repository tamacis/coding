class GenericMethods {
    public static void main(String args[]) {
        Box<Integer> box1 = new Box<Integer>(7, 2, 10); // autoboxing parameters
        Box<Double> box2 = new Box<Double>(11.5, 5.0, 6.5);        
        System.out.println("The volume of box1 is: " + box1.getVolume());
        System.out.println("The volume of box2 is: " + box2.getVolume());

        System.out.println("Invoking static generic method calculateVolume: " + Box.calculateVolume(5, 7, 12)); // autoboxing to Integer
